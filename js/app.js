...
window.addEventListener('scroll', function () {                         //Al hacer scroll, se ejecuta la funcion
    var elements = document.getElementsByClassName('scroll-content');   //Se obtienen todos los elementos con la clase scroll-content
    var screenSize = window.innerHeight;                                //Se obtiene el tamaño de la pantalla               

    for (var i = 0; i < elements.length; i++) {                         //Se recorren todos los elementos
        var element = elements[i];                                      //Se obtiene el elemento actual
